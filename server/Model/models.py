...
class Project(db.Model):
    ...
    created_by = db.Column(db.Integer, ForeignKey("User.user_id"), nullable=False)
    modified_on = db.Column(db.Date, nullable=True)
    modified_by = db.Column(db.Integer, ForeignKey("User.user_id"), nullable=True)
...
class AssignedProjects(db.Model):
    ...
    user_id = db.Column(db.Integer, ForeignKey("User.user_id"), unique=True, nullable=False)
    project_id = db.Column(db.Integer, ForeignKey("Project.project_id"), unique=True, nullable=False)
...
class Issue(db.Model, Base):
    ...
    assigned_to = db.Column(db.Integer, ForeignKey("User.user_id"), nullable=True)
    status = db.Column(db.String, nullable=False)
    label = db.Column(db.String, nullable=True) ### deal with it in the form file where you will list lables json from Projects table
